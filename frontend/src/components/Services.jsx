    ...
    <div className="flex md:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
      ...
      <div className="flex-1 flex flex-wrap justify-start items-center">
        <ServiceCard
          ...
          subtitle="Check the token allowance for different smart contracts."
        />
        <ServiceCard
          color="bg-[#8945F8]"
        ...
        <ServiceCard
          ...
          subtitle="Connect your Metamask Wallet with Krypt and Transfer tokens from your wallet with ease."
        />
        <ServiceCard
          color="bg-[#F84550]"
